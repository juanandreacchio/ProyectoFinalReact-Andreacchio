...
export const Profile = () =>{
    ...
    return(
        logged ? (
        <div className={mode === 'light' ? `${classes.profileContainer}` : `${classes.profileContainer} ${classes.profileContainerDM}`}>
            ...
            <input type="text" disabled placeholder={userName} className={classes.inputProfile} />
            </div>
            <div>
            <p className={classes.profileHeader}>Email</p>
            <input type="text" disabled placeholder={userEmail} className={classes.inputProfile} />
            </div>
